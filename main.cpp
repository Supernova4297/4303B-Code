...
/////
// To whoever attempts to read this code: 頑張って下さい
// Chassis constructor
ez::Drive chassis(
    // These are your drive motors, the first motor is used for sensing!
    {12,  1, 3},     // Left Chassis Ports (negative port will reverse it!)
    {-8, -9, -14},  // Right Chassis Ports (negative port will reverse it!)

    10,      // IMU Port
    2.75,  // Wheel Diameter (Remember, 4" wheels without screw holes are actually 4.125!)
    450);   // Wheel RPM = cartridge * (motor gear / wheel gear)

// Are you using tracking wheels? NO Comment out which ones you're using here!
